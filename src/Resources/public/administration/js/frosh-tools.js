(()=>{var ee=Object.create;var I=Object.defineProperty;var te=Object.getOwnPropertyDescriptor;var se=Object.getOwnPropertyNames;var ae=Object.getPrototypeOf,re=Object.prototype.hasOwnProperty;var ie=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var oe=(e,t,s,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let i of se(t))!re.call(e,i)&&i!==s&&I(e,i,{get:()=>t[i],enumerable:!(a=te(t,i))||a.enumerable});return e};var ne=(e,t,s)=>(s=e!=null?ee(ae(e)):{},oe(t||!e||!e.__esModule?I(s,"default",{value:e,enumerable:!0}):s,e));var Z=ie((Ct,L)=>{var h=function(){this.Diff_Timeout=1,this.Diff_EditCost=4,this.Match_Threshold=.5,this.Match_Distance=1e3,this.Patch_DeleteThreshold=.5,this.Patch_Margin=4,this.Match_MaxBits=32},b=-1,_=1,m=0;h.Diff=function(e,t){return[e,t]};h.prototype.diff_main=function(e,t,s,a){typeof a>"u"&&(this.Diff_Timeout<=0?a=Number.MAX_VALUE:a=new Date().getTime()+this.Diff_Timeout*1e3);var i=a;if(e==null||t==null)throw new Error("Null input. (diff_main)");if(e==t)return e?[new h.Diff(m,e)]:[];typeof s>"u"&&(s=!0);var r=s,o=this.diff_commonPrefix(e,t),n=e.substring(0,o);e=e.substring(o),t=t.substring(o),o=this.diff_commonSuffix(e,t);var l=e.substring(e.length-o);e=e.substring(0,e.length-o),t=t.substring(0,t.length-o);var c=this.diff_compute_(e,t,r,i);return n&&c.unshift(new h.Diff(m,n)),l&&c.push(new h.Diff(m,l)),this.diff_cleanupMerge(c),c};h.prototype.diff_compute_=function(e,t,s,a){var i;if(!e)return[new h.Diff(_,t)];if(!t)return[new h.Diff(b,e)];var r=e.length>t.length?e:t,o=e.length>t.length?t:e,n=r.indexOf(o);if(n!=-1)return i=[new h.Diff(_,r.substring(0,n)),new h.Diff(m,o),new h.Diff(_,r.substring(n+o.length))],e.length>t.length&&(i[0][0]=i[2][0]=b),i;if(o.length==1)return[new h.Diff(b,e),new h.Diff(_,t)];var l=this.diff_halfMatch_(e,t);if(l){var c=l[0],f=l[1],u=l[2],d=l[3],g=l[4],p=this.diff_main(c,u,s,a),v=this.diff_main(f,d,s,a);return p.concat([new h.Diff(m,g)],v)}return s&&e.length>100&&t.length>100?this.diff_lineMode_(e,t,a):this.diff_bisect_(e,t,a)};h.prototype.diff_lineMode_=function(e,t,s){var a=this.diff_linesToChars_(e,t);e=a.chars1,t=a.chars2;var i=a.lineArray,r=this.diff_main(e,t,!1,s);this.diff_charsToLines_(r,i),this.diff_cleanupSemantic(r),r.push(new h.Diff(m,""));for(var o=0,n=0,l=0,c="",f="";o<r.length;){switch(r[o][0]){case _:l++,f+=r[o][1];break;case b:n++,c+=r[o][1];break;case m:if(n>=1&&l>=1){r.splice(o-n-l,n+l),o=o-n-l;for(var u=this.diff_main(c,f,!1,s),d=u.length-1;d>=0;d--)r.splice(o,0,u[d]);o=o+u.length}l=0,n=0,c="",f="";break}o++}return r.pop(),r};h.prototype.diff_bisect_=function(e,t,s){for(var a=e.length,i=t.length,r=Math.ceil((a+i)/2),o=r,n=2*r,l=new Array(n),c=new Array(n),f=0;f<n;f++)l[f]=-1,c[f]=-1;l[o+1]=0,c[o+1]=0;for(var u=a-i,d=u%2!=0,g=0,p=0,v=0,C=0,w=0;w<r&&!(new Date().getTime()>s);w++){for(var S=-w+g;S<=w-p;S+=2){var y=o+S,k;S==-w||S!=w&&l[y-1]<l[y+1]?k=l[y+1]:k=l[y-1]+1;for(var D=k-S;k<a&&D<i&&e.charAt(k)==t.charAt(D);)k++,D++;if(l[y]=k,k>a)p+=2;else if(D>i)g+=2;else if(d){var T=o+u-S;if(T>=0&&T<n&&c[T]!=-1){var M=a-c[T];if(k>=M)return this.diff_bisectSplit_(e,t,k,D,s)}}}for(var A=-w+v;A<=w-C;A+=2){var T=o+A,M;A==-w||A!=w&&c[T-1]<c[T+1]?M=c[T+1]:M=c[T-1]+1;for(var R=M-A;M<a&&R<i&&e.charAt(a-M-1)==t.charAt(i-R-1);)M++,R++;if(c[T]=M,M>a)C+=2;else if(R>i)v+=2;else if(!d){var y=o+u-A;if(y>=0&&y<n&&l[y]!=-1){var k=l[y],D=o+k-y;if(M=a-M,k>=M)return this.diff_bisectSplit_(e,t,k,D,s)}}}}return[new h.Diff(b,e),new h.Diff(_,t)]};h.prototype.diff_bisectSplit_=function(e,t,s,a,i){var r=e.substring(0,s),o=t.substring(0,a),n=e.substring(s),l=t.substring(a),c=this.diff_main(r,o,!1,i),f=this.diff_main(n,l,!1,i);return c.concat(f)};h.prototype.diff_linesToChars_=function(e,t){var s=[],a={};s[0]="";function i(l){for(var c="",f=0,u=-1,d=s.length;u<l.length-1;){u=l.indexOf(`
`,f),u==-1&&(u=l.length-1);var g=l.substring(f,u+1);(a.hasOwnProperty?a.hasOwnProperty(g):a[g]!==void 0)?c+=String.fromCharCode(a[g]):(d==r&&(g=l.substring(f),u=l.length),c+=String.fromCharCode(d),a[g]=d,s[d++]=g),f=u+1}return c}var r=4e4,o=i(e);r=65535;var n=i(t);return{chars1:o,chars2:n,lineArray:s}};h.prototype.diff_charsToLines_=function(e,t){for(var s=0;s<e.length;s++){for(var a=e[s][1],i=[],r=0;r<a.length;r++)i[r]=t[a.charCodeAt(r)];e[s][1]=i.join("")}};h.prototype.diff_commonPrefix=function(e,t){if(!e||!t||e.charAt(0)!=t.charAt(0))return 0;for(var s=0,a=Math.min(e.length,t.length),i=a,r=0;s<i;)e.substring(r,i)==t.substring(r,i)?(s=i,r=s):a=i,i=Math.floor((a-s)/2+s);return i};h.prototype.diff_commonSuffix=function(e,t){if(!e||!t||e.charAt(e.length-1)!=t.charAt(t.length-1))return 0;for(var s=0,a=Math.min(e.length,t.length),i=a,r=0;s<i;)e.substring(e.length-i,e.length-r)==t.substring(t.length-i,t.length-r)?(s=i,r=s):a=i,i=Math.floor((a-s)/2+s);return i};h.prototype.diff_commonOverlap_=function(e,t){var s=e.length,a=t.length;if(s==0||a==0)return 0;s>a?e=e.substring(s-a):s<a&&(t=t.substring(0,s));var i=Math.min(s,a);if(e==t)return i;for(var r=0,o=1;;){var n=e.substring(i-o),l=t.indexOf(n);if(l==-1)return r;o+=l,(l==0||e.substring(i-o)==t.substring(0,o))&&(r=o,o++)}};h.prototype.diff_halfMatch_=function(e,t){if(this.Diff_Timeout<=0)return null;var s=e.length>t.length?e:t,a=e.length>t.length?t:e;if(s.length<4||a.length*2<s.length)return null;var i=this;function r(p,v,C){for(var w=p.substring(C,C+Math.floor(p.length/4)),S=-1,y="",k,D,T,M;(S=v.indexOf(w,S+1))!=-1;){var A=i.diff_commonPrefix(p.substring(C),v.substring(S)),R=i.diff_commonSuffix(p.substring(0,C),v.substring(0,S));y.length<R+A&&(y=v.substring(S-R,S)+v.substring(S,S+A),k=p.substring(0,C-R),D=p.substring(C+A),T=v.substring(0,S-R),M=v.substring(S+A))}return y.length*2>=p.length?[k,D,T,M,y]:null}var o=r(s,a,Math.ceil(s.length/4)),n=r(s,a,Math.ceil(s.length/2)),l;if(!o&&!n)return null;n?o?l=o[4].length>n[4].length?o:n:l=n:l=o;var c,f,u,d;e.length>t.length?(c=l[0],f=l[1],u=l[2],d=l[3]):(u=l[0],d=l[1],c=l[2],f=l[3]);var g=l[4];return[c,f,u,d,g]};h.prototype.diff_cleanupSemantic=function(e){for(var t=!1,s=[],a=0,i=null,r=0,o=0,n=0,l=0,c=0;r<e.length;)e[r][0]==m?(s[a++]=r,o=l,n=c,l=0,c=0,i=e[r][1]):(e[r][0]==_?l+=e[r][1].length:c+=e[r][1].length,i&&i.length<=Math.max(o,n)&&i.length<=Math.max(l,c)&&(e.splice(s[a-1],0,new h.Diff(b,i)),e[s[a-1]+1][0]=_,a--,a--,r=a>0?s[a-1]:-1,o=0,n=0,l=0,c=0,i=null,t=!0)),r++;for(t&&this.diff_cleanupMerge(e),this.diff_cleanupSemanticLossless(e),r=1;r<e.length;){if(e[r-1][0]==b&&e[r][0]==_){var f=e[r-1][1],u=e[r][1],d=this.diff_commonOverlap_(f,u),g=this.diff_commonOverlap_(u,f);d>=g?(d>=f.length/2||d>=u.length/2)&&(e.splice(r,0,new h.Diff(m,u.substring(0,d))),e[r-1][1]=f.substring(0,f.length-d),e[r+1][1]=u.substring(d),r++):(g>=f.length/2||g>=u.length/2)&&(e.splice(r,0,new h.Diff(m,f.substring(0,g))),e[r-1][0]=_,e[r-1][1]=u.substring(0,u.length-g),e[r+1][0]=b,e[r+1][1]=f.substring(g),r++),r++}r++}};h.prototype.diff_cleanupSemanticLossless=function(e){function t(g,p){if(!g||!p)return 6;var v=g.charAt(g.length-1),C=p.charAt(0),w=v.match(h.nonAlphaNumericRegex_),S=C.match(h.nonAlphaNumericRegex_),y=w&&v.match(h.whitespaceRegex_),k=S&&C.match(h.whitespaceRegex_),D=y&&v.match(h.linebreakRegex_),T=k&&C.match(h.linebreakRegex_),M=D&&g.match(h.blanklineEndRegex_),A=T&&p.match(h.blanklineStartRegex_);return M||A?5:D||T?4:w&&!y&&k?3:y||k?2:w||S?1:0}for(var s=1;s<e.length-1;){if(e[s-1][0]==m&&e[s+1][0]==m){var a=e[s-1][1],i=e[s][1],r=e[s+1][1],o=this.diff_commonSuffix(a,i);if(o){var n=i.substring(i.length-o);a=a.substring(0,a.length-o),i=n+i.substring(0,i.length-o),r=n+r}for(var l=a,c=i,f=r,u=t(a,i)+t(i,r);i.charAt(0)===r.charAt(0);){a+=i.charAt(0),i=i.substring(1)+r.charAt(0),r=r.substring(1);var d=t(a,i)+t(i,r);d>=u&&(u=d,l=a,c=i,f=r)}e[s-1][1]!=l&&(l?e[s-1][1]=l:(e.splice(s-1,1),s--),e[s][1]=c,f?e[s+1][1]=f:(e.splice(s+1,1),s--))}s++}};h.nonAlphaNumericRegex_=/[^a-zA-Z0-9]/;h.whitespaceRegex_=/\s/;h.linebreakRegex_=/[\r\n]/;h.blanklineEndRegex_=/\n\r?\n$/;h.blanklineStartRegex_=/^\r?\n\r?\n/;h.prototype.diff_cleanupEfficiency=function(e){for(var t=!1,s=[],a=0,i=null,r=0,o=!1,n=!1,l=!1,c=!1;r<e.length;)e[r][0]==m?(e[r][1].length<this.Diff_EditCost&&(l||c)?(s[a++]=r,o=l,n=c,i=e[r][1]):(a=0,i=null),l=c=!1):(e[r][0]==b?c=!0:l=!0,i&&(o&&n&&l&&c||i.length<this.Diff_EditCost/2&&o+n+l+c==3)&&(e.splice(s[a-1],0,new h.Diff(b,i)),e[s[a-1]+1][0]=_,a--,i=null,o&&n?(l=c=!0,a=0):(a--,r=a>0?s[a-1]:-1,l=c=!1),t=!0)),r++;t&&this.diff_cleanupMerge(e)};h.prototype.diff_cleanupMerge=function(e){e.push(new h.Diff(m,""));for(var t=0,s=0,a=0,i="",r="",o;t<e.length;)switch(e[t][0]){case _:a++,r+=e[t][1],t++;break;case b:s++,i+=e[t][1],t++;break;case m:s+a>1?(s!==0&&a!==0&&(o=this.diff_commonPrefix(r,i),o!==0&&(t-s-a>0&&e[t-s-a-1][0]==m?e[t-s-a-1][1]+=r.substring(0,o):(e.splice(0,0,new h.Diff(m,r.substring(0,o))),t++),r=r.substring(o),i=i.substring(o)),o=this.diff_commonSuffix(r,i),o!==0&&(e[t][1]=r.substring(r.length-o)+e[t][1],r=r.substring(0,r.length-o),i=i.substring(0,i.length-o))),t-=s+a,e.splice(t,s+a),i.length&&(e.splice(t,0,new h.Diff(b,i)),t++),r.length&&(e.splice(t,0,new h.Diff(_,r)),t++),t++):t!==0&&e[t-1][0]==m?(e[t-1][1]+=e[t][1],e.splice(t,1)):t++,a=0,s=0,i="",r="";break}e[e.length-1][1]===""&&e.pop();var n=!1;for(t=1;t<e.length-1;)e[t-1][0]==m&&e[t+1][0]==m&&(e[t][1].substring(e[t][1].length-e[t-1][1].length)==e[t-1][1]?(e[t][1]=e[t-1][1]+e[t][1].substring(0,e[t][1].length-e[t-1][1].length),e[t+1][1]=e[t-1][1]+e[t+1][1],e.splice(t-1,1),n=!0):e[t][1].substring(0,e[t+1][1].length)==e[t+1][1]&&(e[t-1][1]+=e[t+1][1],e[t][1]=e[t][1].substring(e[t+1][1].length)+e[t+1][1],e.splice(t+1,1),n=!0)),t++;n&&this.diff_cleanupMerge(e)};h.prototype.diff_xIndex=function(e,t){var s=0,a=0,i=0,r=0,o;for(o=0;o<e.length&&(e[o][0]!==_&&(s+=e[o][1].length),e[o][0]!==b&&(a+=e[o][1].length),!(s>t));o++)i=s,r=a;return e.length!=o&&e[o][0]===b?r:r+(t-i)};h.prototype.diff_prettyHtml=function(e){for(var t=[],s=/&/g,a=/</g,i=/>/g,r=/\n/g,o=0;o<e.length;o++){var n=e[o][0],l=e[o][1],c=l.replace(s,"&amp;").replace(a,"&lt;").replace(i,"&gt;").replace(r,"&para;<br>");switch(n){case _:t[o]='<ins style="background:#e6ffe6;">'+c+"</ins>";break;case b:t[o]='<del style="background:#ffe6e6;">'+c+"</del>";break;case m:t[o]="<span>"+c+"</span>";break}}return t.join("")};h.prototype.diff_text1=function(e){for(var t=[],s=0;s<e.length;s++)e[s][0]!==_&&(t[s]=e[s][1]);return t.join("")};h.prototype.diff_text2=function(e){for(var t=[],s=0;s<e.length;s++)e[s][0]!==b&&(t[s]=e[s][1]);return t.join("")};h.prototype.diff_levenshtein=function(e){for(var t=0,s=0,a=0,i=0;i<e.length;i++){var r=e[i][0],o=e[i][1];switch(r){case _:s+=o.length;break;case b:a+=o.length;break;case m:t+=Math.max(s,a),s=0,a=0;break}}return t+=Math.max(s,a),t};h.prototype.diff_toDelta=function(e){for(var t=[],s=0;s<e.length;s++)switch(e[s][0]){case _:t[s]="+"+encodeURI(e[s][1]);break;case b:t[s]="-"+e[s][1].length;break;case m:t[s]="="+e[s][1].length;break}return t.join("	").replace(/%20/g," ")};h.prototype.diff_fromDelta=function(e,t){for(var s=[],a=0,i=0,r=t.split(/\t/g),o=0;o<r.length;o++){var n=r[o].substring(1);switch(r[o].charAt(0)){case"+":try{s[a++]=new h.Diff(_,decodeURI(n))}catch{throw new Error("Illegal escape in diff_fromDelta: "+n)}break;case"-":case"=":var l=parseInt(n,10);if(isNaN(l)||l<0)throw new Error("Invalid number in diff_fromDelta: "+n);var c=e.substring(i,i+=l);r[o].charAt(0)=="="?s[a++]=new h.Diff(m,c):s[a++]=new h.Diff(b,c);break;default:if(r[o])throw new Error("Invalid diff operation in diff_fromDelta: "+r[o])}}if(i!=e.length)throw new Error("Delta length ("+i+") does not equal source text length ("+e.length+").");return s};h.prototype.match_main=function(e,t,s){if(e==null||t==null||s==null)throw new Error("Null input. (match_main)");return s=Math.max(0,Math.min(s,e.length)),e==t?0:e.length?e.substring(s,s+t.length)==t?s:this.match_bitap_(e,t,s):-1};h.prototype.match_bitap_=function(e,t,s){if(t.length>this.Match_MaxBits)throw new Error("Pattern too long for this browser.");var a=this.match_alphabet_(t),i=this;function r(k,D){var T=k/t.length,M=Math.abs(s-D);return i.Match_Distance?T+M/i.Match_Distance:M?1:T}var o=this.Match_Threshold,n=e.indexOf(t,s);n!=-1&&(o=Math.min(r(0,n),o),n=e.lastIndexOf(t,s+t.length),n!=-1&&(o=Math.min(r(0,n),o)));var l=1<<t.length-1;n=-1;for(var c,f,u=t.length+e.length,d,g=0;g<t.length;g++){for(c=0,f=u;c<f;)r(g,s+f)<=o?c=f:u=f,f=Math.floor((u-c)/2+c);u=f;var p=Math.max(1,s-f+1),v=Math.min(s+f,e.length)+t.length,C=Array(v+2);C[v+1]=(1<<g)-1;for(var w=v;w>=p;w--){var S=a[e.charAt(w-1)];if(g===0?C[w]=(C[w+1]<<1|1)&S:C[w]=(C[w+1]<<1|1)&S|((d[w+1]|d[w])<<1|1)|d[w+1],C[w]&l){var y=r(g,w-1);if(y<=o)if(o=y,n=w-1,n>s)p=Math.max(1,2*s-n);else break}}if(r(g+1,s)>o)break;d=C}return n};h.prototype.match_alphabet_=function(e){for(var t={},s=0;s<e.length;s++)t[e.charAt(s)]=0;for(var s=0;s<e.length;s++)t[e.charAt(s)]|=1<<e.length-s-1;return t};h.prototype.patch_addContext_=function(e,t){if(t.length!=0){if(e.start2===null)throw Error("patch not initialized");for(var s=t.substring(e.start2,e.start2+e.length1),a=0;t.indexOf(s)!=t.lastIndexOf(s)&&s.length<this.Match_MaxBits-this.Patch_Margin-this.Patch_Margin;)a+=this.Patch_Margin,s=t.substring(e.start2-a,e.start2+e.length1+a);a+=this.Patch_Margin;var i=t.substring(e.start2-a,e.start2);i&&e.diffs.unshift(new h.Diff(m,i));var r=t.substring(e.start2+e.length1,e.start2+e.length1+a);r&&e.diffs.push(new h.Diff(m,r)),e.start1-=i.length,e.start2-=i.length,e.length1+=i.length+r.length,e.length2+=i.length+r.length}};h.prototype.patch_make=function(e,t,s){var a,i;if(typeof e=="string"&&typeof t=="string"&&typeof s>"u")a=e,i=this.diff_main(a,t,!0),i.length>2&&(this.diff_cleanupSemantic(i),this.diff_cleanupEfficiency(i));else if(e&&typeof e=="object"&&typeof t>"u"&&typeof s>"u")i=e,a=this.diff_text1(i);else if(typeof e=="string"&&t&&typeof t=="object"&&typeof s>"u")a=e,i=t;else if(typeof e=="string"&&typeof t=="string"&&s&&typeof s=="object")a=e,i=s;else throw new Error("Unknown call format to patch_make.");if(i.length===0)return[];for(var r=[],o=new h.patch_obj,n=0,l=0,c=0,f=a,u=a,d=0;d<i.length;d++){var g=i[d][0],p=i[d][1];switch(!n&&g!==m&&(o.start1=l,o.start2=c),g){case _:o.diffs[n++]=i[d],o.length2+=p.length,u=u.substring(0,c)+p+u.substring(c);break;case b:o.length1+=p.length,o.diffs[n++]=i[d],u=u.substring(0,c)+u.substring(c+p.length);break;case m:p.length<=2*this.Patch_Margin&&n&&i.length!=d+1?(o.diffs[n++]=i[d],o.length1+=p.length,o.length2+=p.length):p.length>=2*this.Patch_Margin&&n&&(this.patch_addContext_(o,f),r.push(o),o=new h.patch_obj,n=0,f=u,l=c);break}g!==_&&(l+=p.length),g!==b&&(c+=p.length)}return n&&(this.patch_addContext_(o,f),r.push(o)),r};h.prototype.patch_deepCopy=function(e){for(var t=[],s=0;s<e.length;s++){var a=e[s],i=new h.patch_obj;i.diffs=[];for(var r=0;r<a.diffs.length;r++)i.diffs[r]=new h.Diff(a.diffs[r][0],a.diffs[r][1]);i.start1=a.start1,i.start2=a.start2,i.length1=a.length1,i.length2=a.length2,t[s]=i}return t};h.prototype.patch_apply=function(e,t){if(e.length==0)return[t,[]];e=this.patch_deepCopy(e);var s=this.patch_addPadding(e);t=s+t+s,this.patch_splitMax(e);for(var a=0,i=[],r=0;r<e.length;r++){var o=e[r].start2+a,n=this.diff_text1(e[r].diffs),l,c=-1;if(n.length>this.Match_MaxBits?(l=this.match_main(t,n.substring(0,this.Match_MaxBits),o),l!=-1&&(c=this.match_main(t,n.substring(n.length-this.Match_MaxBits),o+n.length-this.Match_MaxBits),(c==-1||l>=c)&&(l=-1))):l=this.match_main(t,n,o),l==-1)i[r]=!1,a-=e[r].length2-e[r].length1;else{i[r]=!0,a=l-o;var f;if(c==-1?f=t.substring(l,l+n.length):f=t.substring(l,c+this.Match_MaxBits),n==f)t=t.substring(0,l)+this.diff_text2(e[r].diffs)+t.substring(l+n.length);else{var u=this.diff_main(n,f,!1);if(n.length>this.Match_MaxBits&&this.diff_levenshtein(u)/n.length>this.Patch_DeleteThreshold)i[r]=!1;else{this.diff_cleanupSemanticLossless(u);for(var d=0,g,p=0;p<e[r].diffs.length;p++){var v=e[r].diffs[p];v[0]!==m&&(g=this.diff_xIndex(u,d)),v[0]===_?t=t.substring(0,l+g)+v[1]+t.substring(l+g):v[0]===b&&(t=t.substring(0,l+g)+t.substring(l+this.diff_xIndex(u,d+v[1].length))),v[0]!==b&&(d+=v[1].length)}}}}}return t=t.substring(s.length,t.length-s.length),[t,i]};h.prototype.patch_addPadding=function(e){for(var t=this.Patch_Margin,s="",a=1;a<=t;a++)s+=String.fromCharCode(a);for(var a=0;a<e.length;a++)e[a].start1+=t,e[a].start2+=t;var i=e[0],r=i.diffs;if(r.length==0||r[0][0]!=m)r.unshift(new h.Diff(m,s)),i.start1-=t,i.start2-=t,i.length1+=t,i.length2+=t;else if(t>r[0][1].length){var o=t-r[0][1].length;r[0][1]=s.substring(r[0][1].length)+r[0][1],i.start1-=o,i.start2-=o,i.length1+=o,i.length2+=o}if(i=e[e.length-1],r=i.diffs,r.length==0||r[r.length-1][0]!=m)r.push(new h.Diff(m,s)),i.length1+=t,i.length2+=t;else if(t>r[r.length-1][1].length){var o=t-r[r.length-1][1].length;r[r.length-1][1]+=s.substring(0,o),i.length1+=o,i.length2+=o}return s};h.prototype.patch_splitMax=function(e){for(var t=this.Match_MaxBits,s=0;s<e.length;s++)if(!(e[s].length1<=t)){var a=e[s];e.splice(s--,1);for(var i=a.start1,r=a.start2,o="";a.diffs.length!==0;){var n=new h.patch_obj,l=!0;for(n.start1=i-o.length,n.start2=r-o.length,o!==""&&(n.length1=n.length2=o.length,n.diffs.push(new h.Diff(m,o)));a.diffs.length!==0&&n.length1<t-this.Patch_Margin;){var c=a.diffs[0][0],f=a.diffs[0][1];c===_?(n.length2+=f.length,r+=f.length,n.diffs.push(a.diffs.shift()),l=!1):c===b&&n.diffs.length==1&&n.diffs[0][0]==m&&f.length>2*t?(n.length1+=f.length,i+=f.length,l=!1,n.diffs.push(new h.Diff(c,f)),a.diffs.shift()):(f=f.substring(0,t-n.length1-this.Patch_Margin),n.length1+=f.length,i+=f.length,c===m?(n.length2+=f.length,r+=f.length):l=!1,n.diffs.push(new h.Diff(c,f)),f==a.diffs[0][1]?a.diffs.shift():a.diffs[0][1]=a.diffs[0][1].substring(f.length))}o=this.diff_text2(n.diffs),o=o.substring(o.length-this.Patch_Margin);var u=this.diff_text1(a.diffs).substring(0,this.Patch_Margin);u!==""&&(n.length1+=u.length,n.length2+=u.length,n.diffs.length!==0&&n.diffs[n.diffs.length-1][0]===m?n.diffs[n.diffs.length-1][1]+=u:n.diffs.push(new h.Diff(m,u))),l||e.splice(++s,0,n)}}};h.prototype.patch_toText=function(e){for(var t=[],s=0;s<e.length;s++)t[s]=e[s];return t.join("")};h.prototype.patch_fromText=function(e){var t=[];if(!e)return t;for(var s=e.split(`
`),a=0,i=/^@@ -(\d+),?(\d*) \+(\d+),?(\d*) @@$/;a<s.length;){var r=s[a].match(i);if(!r)throw new Error("Invalid patch string: "+s[a]);var o=new h.patch_obj;for(t.push(o),o.start1=parseInt(r[1],10),r[2]===""?(o.start1--,o.length1=1):r[2]=="0"?o.length1=0:(o.start1--,o.length1=parseInt(r[2],10)),o.start2=parseInt(r[3],10),r[4]===""?(o.start2--,o.length2=1):r[4]=="0"?o.length2=0:(o.start2--,o.length2=parseInt(r[4],10)),a++;a<s.length;){var n=s[a].charAt(0);try{var l=decodeURI(s[a].substring(1))}catch{throw new Error("Illegal escape in patch_fromText: "+l)}if(n=="-")o.diffs.push(new h.Diff(b,l));else if(n=="+")o.diffs.push(new h.Diff(_,l));else if(n==" ")o.diffs.push(new h.Diff(m,l));else{if(n=="@")break;if(n!=="")throw new Error('Invalid patch mode "'+n+'" in: '+l)}a++}}return t};h.patch_obj=function(){this.diffs=[],this.start1=null,this.start2=null,this.length1=0,this.length2=0};h.patch_obj.prototype.toString=function(){var e,t;this.length1===0?e=this.start1+",0":this.length1==1?e=this.start1+1:e=this.start1+1+","+this.length1,this.length2===0?t=this.start2+",0":this.length2==1?t=this.start2+1:t=this.start2+1+","+this.length2;for(var s=["@@ -"+e+" +"+t+` @@
`],a,i=0;i<this.diffs.length;i++){switch(this.diffs[i][0]){case _:a="+";break;case b:a="-";break;case m:a=" ";break}s[i+1]=a+encodeURI(this.diffs[i][1])+`
`}return s.join("").replace(/%20/g," ")};L.exports=h;L.exports.diff_match_patch=h;L.exports.DIFF_DELETE=b;L.exports.DIFF_INSERT=_;L.exports.DIFF_EQUAL=m});var{ApiService:$}=Shopware.Classes,P=class extends ${constructor(t,s,a="_action/frosh-tools"){super(t,s,a)}getCacheInfo(){let t=`${this.getApiBasePath()}/cache`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}clearCache(t){let s=`${this.getApiBasePath()}/cache/${t}`;return this.httpClient.delete(s,{headers:this.getBasicHeaders()}).then(a=>$.handleResponse(a))}getQueue(){let t=`${this.getApiBasePath()}/queue/list`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}resetQueue(){let t=`${this.getApiBasePath()}/queue`;return this.httpClient.delete(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}runScheduledTask(t){let s=`${this.getApiBasePath()}/scheduled-task/${t}`;return this.httpClient.post(s,{},{headers:this.getBasicHeaders()}).then(a=>$.handleResponse(a))}scheduledTasksRegister(){let t=`${this.getApiBasePath()}/scheduled-tasks/register`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}healthStatus(){let t=`${this.getApiBasePath()}/health/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}performanceStatus(){let t=`${this.getApiBasePath()}/performance/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}getLogFiles(){let t=`${this.getApiBasePath()}/logs/files`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}getLogFile(t,s=0,a=20){let i=`${this.getApiBasePath()}/logs/file`;return this.httpClient.get(i,{params:{file:t,offset:s,limit:a},headers:this.getBasicHeaders()}).then(r=>r)}getShopwareFiles(){let t=`${this.getApiBasePath()}/shopware-files`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>s)}getFileContents(t){let s=`${this.getApiBasePath()}/file-contents`;return this.httpClient.get(s,{params:{file:t},headers:this.getBasicHeaders()}).then(a=>a)}restoreShopwareFile(t){let s=`${this.getApiBasePath()}/shopware-file/restore`;return this.httpClient.get(s,{params:{file:t},headers:this.getBasicHeaders()}).then(a=>a)}getFeatureFlags(){let t=`${this.getApiBasePath()}/feature-flag/list`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>$.handleResponse(s))}toggleFeatureFlag(t){let s=`${this.getApiBasePath()}/feature-flag/toggle`;return this.httpClient.post(s,{flag:t},{headers:this.getBasicHeaders()}).then(a=>$.handleResponse(a))}stateMachines(t){let s=`${this.getApiBasePath()}/state-machines/load`;return this.httpClient.get(s,{params:{stateMachine:t},headers:this.getBasicHeaders()}).then(a=>$.handleResponse(a))}},N=P;var{ApiService:E}=Shopware.Classes,F=class extends E{constructor(t,s,a="_action/frosh-tools/elasticsearch"){super(t,s,a)}status(){let t=`${this.getApiBasePath()}/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}indices(){let t=`${this.getApiBasePath()}/indices`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}deleteIndex(t){let s=`${this.getApiBasePath()}/index/`+t;return this.httpClient.delete(s,{headers:this.getBasicHeaders()}).then(a=>E.handleResponse(a))}console(t,s,a){let i=`${this.getApiBasePath()}/console`+s;return this.httpClient.request({url:i,method:t,headers:{...this.getBasicHeaders(),"content-type":"application/json"},data:a}).then(r=>E.handleResponse(r))}flushAll(){let t=`${this.getApiBasePath()}/flush_all`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}reindex(){let t=`${this.getApiBasePath()}/reindex`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}switchAlias(){let t=`${this.getApiBasePath()}/switch_alias`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}cleanup(){let t=`${this.getApiBasePath()}/cleanup`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}reset(){let t=`${this.getApiBasePath()}/reset`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}},H=F;var{Application:B}=Shopware;B.addServiceProvider("froshToolsService",e=>{let t=B.getContainer("init");return new N(t.httpClient,e.loginService)});B.addServiceProvider("froshElasticSearch",e=>{let t=B.getContainer("init");return new H(t.httpClient,e.loginService)});var O=`{% block sw_data_grid_inline_edit_type_unknown %}
    <sw-datepicker
    ...
    {% parent() %}
{% endblock %}
`;var{Component:he}=Shopware;he.override("sw-data-grid-inline-edit",{template:O});var j=`{% block sw_version_status %}
    <router-link
        v-if="hasPermission"
...
`;var{Component:de}=Shopware;de.register("frosh-tools-tab-index",{inject:["froshToolsService"],template:z,data(){return{isLoading:!0,health:null,performanceStatus:null}},created(){this.createdComponent()},computed:{columns(){return[{property:"name",label:"frosh-tools.name",rawData:!0},{property:"current",label:"frosh-tools.current",rawData:!0},{property:"recommended",label:"frosh-tools.recommended",rawData:!0}]}},methods:{async refresh(){this.isLoading=!0,await this.createdComponent()},async createdComponent(){this.health=await this.froshToolsService.healthStatus(),this.performanceStatus=await this.froshToolsService.performanceStatus(),this.isLoading=!1}}});var U=`<sw-card-view>
...
`;var{Mixin:Me,Component:Te}=Shopware;Te.register("frosh-tools-tab-elasticsearch",{template:V,inject:["froshElasticSearch"],mixins:[Me.getByName("notification")],data(){return{isLoading:!0,isActive:!0,statusInfo:{},indices:[],consoleInput:"GET /_cat/indices",consoleOutput:{}}},computed:{columns(){return[{property:"name",label:"frosh-tools.name",rawData:!0,primary:!0},{property:"indexSize",label:"frosh-tools.size",rawData:!0,primary:!0},{property:"docs",label:"frosh-tools.docs",rawData:!0,primary:!0}]}},created(){this.createdComponent()},methods:{async createdComponent(){this.isLoading=!0;try{this.statusInfo=await this.froshElasticSearch.status()}catch{this.isActive=!1,this.isLoading=!1;return}finally{this.isLoading=!1}this.indices=await this.froshElasticSearch.indices()},formatSize(e){let a=e;if(Math.abs(e)<1024)return e+" B";let i=["KiB","MiB","GiB","TiB","PiB","EiB","ZiB","YiB"],r=-1,o=10**1;do a/=1024,++r;while(Math.round(Math.abs(a)*o)/o>=1024&&r<i.length-1);return a.toFixed(1)+" "+i[r]},async deleteIndex(e){await this.froshElasticSearch.deleteIndex(e),await this.createdComponent()},async onConsoleEnter(){let e=this.consoleInput.split(`
`),t=e.shift(),s=e.join(`
