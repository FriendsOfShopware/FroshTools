(()=>{var x=Object.create;var F=Object.defineProperty;var ee=Object.getOwnPropertyDescriptor;var te=Object.getOwnPropertyNames;var se=Object.getPrototypeOf,ae=Object.prototype.hasOwnProperty;var ie=(e,t)=>()=>(t||e((t={exports:{}}).exports,t),t.exports);var re=(e,t,s,a)=>{if(t&&typeof t=="object"||typeof t=="function")for(let r of te(t))!ae.call(e,r)&&r!==s&&F(e,r,{get:()=>t[r],enumerable:!(a=ee(t,r))||a.enumerable});return e};var ne=(e,t,s)=>(s=e!=null?x(se(e)):{},re(t||!e||!e.__esModule?F(s,"default",{value:e,enumerable:!0}):s,e));var X=ie((kt,L)=>{var h=function(){this.Diff_Timeout=1,this.Diff_EditCost=4,this.Match_Threshold=.5,this.Match_Distance=1e3,this.Patch_DeleteThreshold=.5,this.Patch_Margin=4,this.Match_MaxBits=32},b=-1,_=1,d=0;h.Diff=function(e,t){return[e,t]};h.prototype.diff_main=function(e,t,s,a){typeof a>"u"&&(this.Diff_Timeout<=0?a=Number.MAX_VALUE:a=new Date().getTime()+this.Diff_Timeout*1e3);var r=a;if(e==null||t==null)throw new Error("Null input. (diff_main)");if(e==t)return e?[new h.Diff(d,e)]:[];typeof s>"u"&&(s=!0);var i=s,n=this.diff_commonPrefix(e,t),o=e.substring(0,n);e=e.substring(n),t=t.substring(n),n=this.diff_commonSuffix(e,t);var l=e.substring(e.length-n);e=e.substring(0,e.length-n),t=t.substring(0,t.length-n);var c=this.diff_compute_(e,t,i,r);return o&&c.unshift(new h.Diff(d,o)),l&&c.push(new h.Diff(d,l)),this.diff_cleanupMerge(c),c};h.prototype.diff_compute_=function(e,t,s,a){var r;if(!e)return[new h.Diff(_,t)];if(!t)return[new h.Diff(b,e)];var i=e.length>t.length?e:t,n=e.length>t.length?t:e,o=i.indexOf(n);if(o!=-1)return r=[new h.Diff(_,i.substring(0,o)),new h.Diff(d,n),new h.Diff(_,i.substring(o+n.length))],e.length>t.length&&(r[0][0]=r[2][0]=b),r;if(n.length==1)return[new h.Diff(b,e),new h.Diff(_,t)];var l=this.diff_halfMatch_(e,t);if(l){var c=l[0],f=l[1],u=l[2],g=l[3],m=l[4],p=this.diff_main(c,u,s,a),w=this.diff_main(f,g,s,a);return p.concat([new h.Diff(d,m)],w)}return s&&e.length>100&&t.length>100?this.diff_lineMode_(e,t,a):this.diff_bisect_(e,t,a)};h.prototype.diff_lineMode_=function(e,t,s){var a=this.diff_linesToChars_(e,t);e=a.chars1,t=a.chars2;var r=a.lineArray,i=this.diff_main(e,t,!1,s);this.diff_charsToLines_(i,r),this.diff_cleanupSemantic(i),i.push(new h.Diff(d,""));for(var n=0,o=0,l=0,c="",f="";n<i.length;){switch(i[n][0]){case _:l++,f+=i[n][1];break;case b:o++,c+=i[n][1];break;case d:if(o>=1&&l>=1){i.splice(n-o-l,o+l),n=n-o-l;for(var u=this.diff_main(c,f,!1,s),g=u.length-1;g>=0;g--)i.splice(n,0,u[g]);n=n+u.length}l=0,o=0,c="",f="";break}n++}return i.pop(),i};h.prototype.diff_bisect_=function(e,t,s){for(var a=e.length,r=t.length,i=Math.ceil((a+r)/2),n=i,o=2*i,l=new Array(o),c=new Array(o),f=0;f<o;f++)l[f]=-1,c[f]=-1;l[n+1]=0,c[n+1]=0;for(var u=a-r,g=u%2!=0,m=0,p=0,w=0,M=0,v=0;v<i&&!(new Date().getTime()>s);v++){for(var S=-v+m;S<=v-p;S+=2){var y=n+S,C;S==-v||S!=v&&l[y-1]<l[y+1]?C=l[y+1]:C=l[y-1]+1;for(var T=C-S;C<a&&T<r&&e.charAt(C)==t.charAt(T);)C++,T++;if(l[y]=C,C>a)p+=2;else if(T>r)m+=2;else if(g){var A=n+u-S;if(A>=0&&A<o&&c[A]!=-1){var k=a-c[A];if(C>=k)return this.diff_bisectSplit_(e,t,C,T,s)}}}for(var D=-v+w;D<=v-M;D+=2){var A=n+D,k;D==-v||D!=v&&c[A-1]<c[A+1]?k=c[A+1]:k=c[A-1]+1;for(var $=k-D;k<a&&$<r&&e.charAt(a-k-1)==t.charAt(r-$-1);)k++,$++;if(c[A]=k,k>a)M+=2;else if($>r)w+=2;else if(!g){var y=n+u-D;if(y>=0&&y<o&&l[y]!=-1){var C=l[y],T=n+C-y;if(k=a-k,C>=k)return this.diff_bisectSplit_(e,t,C,T,s)}}}}return[new h.Diff(b,e),new h.Diff(_,t)]};h.prototype.diff_bisectSplit_=function(e,t,s,a,r){var i=e.substring(0,s),n=t.substring(0,a),o=e.substring(s),l=t.substring(a),c=this.diff_main(i,n,!1,r),f=this.diff_main(o,l,!1,r);return c.concat(f)};h.prototype.diff_linesToChars_=function(e,t){var s=[],a={};s[0]="";function r(l){for(var c="",f=0,u=-1,g=s.length;u<l.length-1;){u=l.indexOf(`
`,f),u==-1&&(u=l.length-1);var m=l.substring(f,u+1);(a.hasOwnProperty?a.hasOwnProperty(m):a[m]!==void 0)?c+=String.fromCharCode(a[m]):(g==i&&(m=l.substring(f),u=l.length),c+=String.fromCharCode(g),a[m]=g,s[g++]=m),f=u+1}return c}var i=4e4,n=r(e);i=65535;var o=r(t);return{chars1:n,chars2:o,lineArray:s}};h.prototype.diff_charsToLines_=function(e,t){for(var s=0;s<e.length;s++){for(var a=e[s][1],r=[],i=0;i<a.length;i++)r[i]=t[a.charCodeAt(i)];e[s][1]=r.join("")}};h.prototype.diff_commonPrefix=function(e,t){if(!e||!t||e.charAt(0)!=t.charAt(0))return 0;for(var s=0,a=Math.min(e.length,t.length),r=a,i=0;s<r;)e.substring(i,r)==t.substring(i,r)?(s=r,i=s):a=r,r=Math.floor((a-s)/2+s);return r};h.prototype.diff_commonSuffix=function(e,t){if(!e||!t||e.charAt(e.length-1)!=t.charAt(t.length-1))return 0;for(var s=0,a=Math.min(e.length,t.length),r=a,i=0;s<r;)e.substring(e.length-r,e.length-i)==t.substring(t.length-r,t.length-i)?(s=r,i=s):a=r,r=Math.floor((a-s)/2+s);return r};h.prototype.diff_commonOverlap_=function(e,t){var s=e.length,a=t.length;if(s==0||a==0)return 0;s>a?e=e.substring(s-a):s<a&&(t=t.substring(0,s));var r=Math.min(s,a);if(e==t)return r;for(var i=0,n=1;;){var o=e.substring(r-n),l=t.indexOf(o);if(l==-1)return i;n+=l,(l==0||e.substring(r-n)==t.substring(0,n))&&(i=n,n++)}};h.prototype.diff_halfMatch_=function(e,t){if(this.Diff_Timeout<=0)return null;var s=e.length>t.length?e:t,a=e.length>t.length?t:e;if(s.length<4||a.length*2<s.length)return null;var r=this;function i(p,w,M){for(var v=p.substring(M,M+Math.floor(p.length/4)),S=-1,y="",C,T,A,k;(S=w.indexOf(v,S+1))!=-1;){var D=r.diff_commonPrefix(p.substring(M),w.substring(S)),$=r.diff_commonSuffix(p.substring(0,M),w.substring(0,S));y.length<$+D&&(y=w.substring(S-$,S)+w.substring(S,S+D),C=p.substring(0,M-$),T=p.substring(M+D),A=w.substring(0,S-$),k=w.substring(S+D))}return y.length*2>=p.length?[C,T,A,k,y]:null}var n=i(s,a,Math.ceil(s.length/4)),o=i(s,a,Math.ceil(s.length/2)),l;if(!n&&!o)return null;o?n?l=n[4].length>o[4].length?n:o:l=o:l=n;var c,f,u,g;e.length>t.length?(c=l[0],f=l[1],u=l[2],g=l[3]):(u=l[0],g=l[1],c=l[2],f=l[3]);var m=l[4];return[c,f,u,g,m]};h.prototype.diff_cleanupSemantic=function(e){for(var t=!1,s=[],a=0,r=null,i=0,n=0,o=0,l=0,c=0;i<e.length;)e[i][0]==d?(s[a++]=i,n=l,o=c,l=0,c=0,r=e[i][1]):(e[i][0]==_?l+=e[i][1].length:c+=e[i][1].length,r&&r.length<=Math.max(n,o)&&r.length<=Math.max(l,c)&&(e.splice(s[a-1],0,new h.Diff(b,r)),e[s[a-1]+1][0]=_,a--,a--,i=a>0?s[a-1]:-1,n=0,o=0,l=0,c=0,r=null,t=!0)),i++;for(t&&this.diff_cleanupMerge(e),this.diff_cleanupSemanticLossless(e),i=1;i<e.length;){if(e[i-1][0]==b&&e[i][0]==_){var f=e[i-1][1],u=e[i][1],g=this.diff_commonOverlap_(f,u),m=this.diff_commonOverlap_(u,f);g>=m?(g>=f.length/2||g>=u.length/2)&&(e.splice(i,0,new h.Diff(d,u.substring(0,g))),e[i-1][1]=f.substring(0,f.length-g),e[i+1][1]=u.substring(g),i++):(m>=f.length/2||m>=u.length/2)&&(e.splice(i,0,new h.Diff(d,f.substring(0,m))),e[i-1][0]=_,e[i-1][1]=u.substring(0,u.length-m),e[i+1][0]=b,e[i+1][1]=f.substring(m),i++),i++}i++}};h.prototype.diff_cleanupSemanticLossless=function(e){function t(m,p){if(!m||!p)return 6;var w=m.charAt(m.length-1),M=p.charAt(0),v=w.match(h.nonAlphaNumericRegex_),S=M.match(h.nonAlphaNumericRegex_),y=v&&w.match(h.whitespaceRegex_),C=S&&M.match(h.whitespaceRegex_),T=y&&w.match(h.linebreakRegex_),A=C&&M.match(h.linebreakRegex_),k=T&&m.match(h.blanklineEndRegex_),D=A&&p.match(h.blanklineStartRegex_);return k||D?5:T||A?4:v&&!y&&C?3:y||C?2:v||S?1:0}for(var s=1;s<e.length-1;){if(e[s-1][0]==d&&e[s+1][0]==d){var a=e[s-1][1],r=e[s][1],i=e[s+1][1],n=this.diff_commonSuffix(a,r);if(n){var o=r.substring(r.length-n);a=a.substring(0,a.length-n),r=o+r.substring(0,r.length-n),i=o+i}for(var l=a,c=r,f=i,u=t(a,r)+t(r,i);r.charAt(0)===i.charAt(0);){a+=r.charAt(0),r=r.substring(1)+i.charAt(0),i=i.substring(1);var g=t(a,r)+t(r,i);g>=u&&(u=g,l=a,c=r,f=i)}e[s-1][1]!=l&&(l?e[s-1][1]=l:(e.splice(s-1,1),s--),e[s][1]=c,f?e[s+1][1]=f:(e.splice(s+1,1),s--))}s++}};h.nonAlphaNumericRegex_=/[^a-zA-Z0-9]/;h.whitespaceRegex_=/\s/;h.linebreakRegex_=/[\r\n]/;h.blanklineEndRegex_=/\n\r?\n$/;h.blanklineStartRegex_=/^\r?\n\r?\n/;h.prototype.diff_cleanupEfficiency=function(e){for(var t=!1,s=[],a=0,r=null,i=0,n=!1,o=!1,l=!1,c=!1;i<e.length;)e[i][0]==d?(e[i][1].length<this.Diff_EditCost&&(l||c)?(s[a++]=i,n=l,o=c,r=e[i][1]):(a=0,r=null),l=c=!1):(e[i][0]==b?c=!0:l=!0,r&&(n&&o&&l&&c||r.length<this.Diff_EditCost/2&&n+o+l+c==3)&&(e.splice(s[a-1],0,new h.Diff(b,r)),e[s[a-1]+1][0]=_,a--,r=null,n&&o?(l=c=!0,a=0):(a--,i=a>0?s[a-1]:-1,l=c=!1),t=!0)),i++;t&&this.diff_cleanupMerge(e)};h.prototype.diff_cleanupMerge=function(e){e.push(new h.Diff(d,""));for(var t=0,s=0,a=0,r="",i="",n;t<e.length;)switch(e[t][0]){case _:a++,i+=e[t][1],t++;break;case b:s++,r+=e[t][1],t++;break;case d:s+a>1?(s!==0&&a!==0&&(n=this.diff_commonPrefix(i,r),n!==0&&(t-s-a>0&&e[t-s-a-1][0]==d?e[t-s-a-1][1]+=i.substring(0,n):(e.splice(0,0,new h.Diff(d,i.substring(0,n))),t++),i=i.substring(n),r=r.substring(n)),n=this.diff_commonSuffix(i,r),n!==0&&(e[t][1]=i.substring(i.length-n)+e[t][1],i=i.substring(0,i.length-n),r=r.substring(0,r.length-n))),t-=s+a,e.splice(t,s+a),r.length&&(e.splice(t,0,new h.Diff(b,r)),t++),i.length&&(e.splice(t,0,new h.Diff(_,i)),t++),t++):t!==0&&e[t-1][0]==d?(e[t-1][1]+=e[t][1],e.splice(t,1)):t++,a=0,s=0,r="",i="";break}e[e.length-1][1]===""&&e.pop();var o=!1;for(t=1;t<e.length-1;)e[t-1][0]==d&&e[t+1][0]==d&&(e[t][1].substring(e[t][1].length-e[t-1][1].length)==e[t-1][1]?(e[t][1]=e[t-1][1]+e[t][1].substring(0,e[t][1].length-e[t-1][1].length),e[t+1][1]=e[t-1][1]+e[t+1][1],e.splice(t-1,1),o=!0):e[t][1].substring(0,e[t+1][1].length)==e[t+1][1]&&(e[t-1][1]+=e[t+1][1],e[t][1]=e[t][1].substring(e[t+1][1].length)+e[t+1][1],e.splice(t+1,1),o=!0)),t++;o&&this.diff_cleanupMerge(e)};h.prototype.diff_xIndex=function(e,t){var s=0,a=0,r=0,i=0,n;for(n=0;n<e.length&&(e[n][0]!==_&&(s+=e[n][1].length),e[n][0]!==b&&(a+=e[n][1].length),!(s>t));n++)r=s,i=a;return e.length!=n&&e[n][0]===b?i:i+(t-r)};h.prototype.diff_prettyHtml=function(e){for(var t=[],s=/&/g,a=/</g,r=/>/g,i=/\n/g,n=0;n<e.length;n++){var o=e[n][0],l=e[n][1],c=l.replace(s,"&amp;").replace(a,"&lt;").replace(r,"&gt;").replace(i,"&para;<br>");switch(o){case _:t[n]='<ins style="background:#e6ffe6;">'+c+"</ins>";break;case b:t[n]='<del style="background:#ffe6e6;">'+c+"</del>";break;case d:t[n]="<span>"+c+"</span>";break}}return t.join("")};h.prototype.diff_text1=function(e){for(var t=[],s=0;s<e.length;s++)e[s][0]!==_&&(t[s]=e[s][1]);return t.join("")};h.prototype.diff_text2=function(e){for(var t=[],s=0;s<e.length;s++)e[s][0]!==b&&(t[s]=e[s][1]);return t.join("")};h.prototype.diff_levenshtein=function(e){for(var t=0,s=0,a=0,r=0;r<e.length;r++){var i=e[r][0],n=e[r][1];switch(i){case _:s+=n.length;break;case b:a+=n.length;break;case d:t+=Math.max(s,a),s=0,a=0;break}}return t+=Math.max(s,a),t};h.prototype.diff_toDelta=function(e){for(var t=[],s=0;s<e.length;s++)switch(e[s][0]){case _:t[s]="+"+encodeURI(e[s][1]);break;case b:t[s]="-"+e[s][1].length;break;case d:t[s]="="+e[s][1].length;break}return t.join("	").replace(/%20/g," ")};h.prototype.diff_fromDelta=function(e,t){for(var s=[],a=0,r=0,i=t.split(/\t/g),n=0;n<i.length;n++){var o=i[n].substring(1);switch(i[n].charAt(0)){case"+":try{s[a++]=new h.Diff(_,decodeURI(o))}catch{throw new Error("Illegal escape in diff_fromDelta: "+o)}break;case"-":case"=":var l=parseInt(o,10);if(isNaN(l)||l<0)throw new Error("Invalid number in diff_fromDelta: "+o);var c=e.substring(r,r+=l);i[n].charAt(0)=="="?s[a++]=new h.Diff(d,c):s[a++]=new h.Diff(b,c);break;default:if(i[n])throw new Error("Invalid diff operation in diff_fromDelta: "+i[n])}}if(r!=e.length)throw new Error("Delta length ("+r+") does not equal source text length ("+e.length+").");return s};h.prototype.match_main=function(e,t,s){if(e==null||t==null||s==null)throw new Error("Null input. (match_main)");return s=Math.max(0,Math.min(s,e.length)),e==t?0:e.length?e.substring(s,s+t.length)==t?s:this.match_bitap_(e,t,s):-1};h.prototype.match_bitap_=function(e,t,s){if(t.length>this.Match_MaxBits)throw new Error("Pattern too long for this browser.");var a=this.match_alphabet_(t),r=this;function i(C,T){var A=C/t.length,k=Math.abs(s-T);return r.Match_Distance?A+k/r.Match_Distance:k?1:A}var n=this.Match_Threshold,o=e.indexOf(t,s);o!=-1&&(n=Math.min(i(0,o),n),o=e.lastIndexOf(t,s+t.length),o!=-1&&(n=Math.min(i(0,o),n)));var l=1<<t.length-1;o=-1;for(var c,f,u=t.length+e.length,g,m=0;m<t.length;m++){for(c=0,f=u;c<f;)i(m,s+f)<=n?c=f:u=f,f=Math.floor((u-c)/2+c);u=f;var p=Math.max(1,s-f+1),w=Math.min(s+f,e.length)+t.length,M=Array(w+2);M[w+1]=(1<<m)-1;for(var v=w;v>=p;v--){var S=a[e.charAt(v-1)];if(m===0?M[v]=(M[v+1]<<1|1)&S:M[v]=(M[v+1]<<1|1)&S|((g[v+1]|g[v])<<1|1)|g[v+1],M[v]&l){var y=i(m,v-1);if(y<=n)if(n=y,o=v-1,o>s)p=Math.max(1,2*s-o);else break}}if(i(m+1,s)>n)break;g=M}return o};h.prototype.match_alphabet_=function(e){for(var t={},s=0;s<e.length;s++)t[e.charAt(s)]=0;for(var s=0;s<e.length;s++)t[e.charAt(s)]|=1<<e.length-s-1;return t};h.prototype.patch_addContext_=function(e,t){if(t.length!=0){if(e.start2===null)throw Error("patch not initialized");for(var s=t.substring(e.start2,e.start2+e.length1),a=0;t.indexOf(s)!=t.lastIndexOf(s)&&s.length<this.Match_MaxBits-this.Patch_Margin-this.Patch_Margin;)a+=this.Patch_Margin,s=t.substring(e.start2-a,e.start2+e.length1+a);a+=this.Patch_Margin;var r=t.substring(e.start2-a,e.start2);r&&e.diffs.unshift(new h.Diff(d,r));var i=t.substring(e.start2+e.length1,e.start2+e.length1+a);i&&e.diffs.push(new h.Diff(d,i)),e.start1-=r.length,e.start2-=r.length,e.length1+=r.length+i.length,e.length2+=r.length+i.length}};h.prototype.patch_make=function(e,t,s){var a,r;if(typeof e=="string"&&typeof t=="string"&&typeof s>"u")a=e,r=this.diff_main(a,t,!0),r.length>2&&(this.diff_cleanupSemantic(r),this.diff_cleanupEfficiency(r));else if(e&&typeof e=="object"&&typeof t>"u"&&typeof s>"u")r=e,a=this.diff_text1(r);else if(typeof e=="string"&&t&&typeof t=="object"&&typeof s>"u")a=e,r=t;else if(typeof e=="string"&&typeof t=="string"&&s&&typeof s=="object")a=e,r=s;else throw new Error("Unknown call format to patch_make.");if(r.length===0)return[];for(var i=[],n=new h.patch_obj,o=0,l=0,c=0,f=a,u=a,g=0;g<r.length;g++){var m=r[g][0],p=r[g][1];switch(!o&&m!==d&&(n.start1=l,n.start2=c),m){case _:n.diffs[o++]=r[g],n.length2+=p.length,u=u.substring(0,c)+p+u.substring(c);break;case b:n.length1+=p.length,n.diffs[o++]=r[g],u=u.substring(0,c)+u.substring(c+p.length);break;case d:p.length<=2*this.Patch_Margin&&o&&r.length!=g+1?(n.diffs[o++]=r[g],n.length1+=p.length,n.length2+=p.length):p.length>=2*this.Patch_Margin&&o&&(this.patch_addContext_(n,f),i.push(n),n=new h.patch_obj,o=0,f=u,l=c);break}m!==_&&(l+=p.length),m!==b&&(c+=p.length)}return o&&(this.patch_addContext_(n,f),i.push(n)),i};h.prototype.patch_deepCopy=function(e){for(var t=[],s=0;s<e.length;s++){var a=e[s],r=new h.patch_obj;r.diffs=[];for(var i=0;i<a.diffs.length;i++)r.diffs[i]=new h.Diff(a.diffs[i][0],a.diffs[i][1]);r.start1=a.start1,r.start2=a.start2,r.length1=a.length1,r.length2=a.length2,t[s]=r}return t};h.prototype.patch_apply=function(e,t){if(e.length==0)return[t,[]];e=this.patch_deepCopy(e);var s=this.patch_addPadding(e);t=s+t+s,this.patch_splitMax(e);for(var a=0,r=[],i=0;i<e.length;i++){var n=e[i].start2+a,o=this.diff_text1(e[i].diffs),l,c=-1;if(o.length>this.Match_MaxBits?(l=this.match_main(t,o.substring(0,this.Match_MaxBits),n),l!=-1&&(c=this.match_main(t,o.substring(o.length-this.Match_MaxBits),n+o.length-this.Match_MaxBits),(c==-1||l>=c)&&(l=-1))):l=this.match_main(t,o,n),l==-1)r[i]=!1,a-=e[i].length2-e[i].length1;else{r[i]=!0,a=l-n;var f;if(c==-1?f=t.substring(l,l+o.length):f=t.substring(l,c+this.Match_MaxBits),o==f)t=t.substring(0,l)+this.diff_text2(e[i].diffs)+t.substring(l+o.length);else{var u=this.diff_main(o,f,!1);if(o.length>this.Match_MaxBits&&this.diff_levenshtein(u)/o.length>this.Patch_DeleteThreshold)r[i]=!1;else{this.diff_cleanupSemanticLossless(u);for(var g=0,m,p=0;p<e[i].diffs.length;p++){var w=e[i].diffs[p];w[0]!==d&&(m=this.diff_xIndex(u,g)),w[0]===_?t=t.substring(0,l+m)+w[1]+t.substring(l+m):w[0]===b&&(t=t.substring(0,l+m)+t.substring(l+this.diff_xIndex(u,g+w[1].length))),w[0]!==b&&(g+=w[1].length)}}}}}return t=t.substring(s.length,t.length-s.length),[t,r]};h.prototype.patch_addPadding=function(e){for(var t=this.Patch_Margin,s="",a=1;a<=t;a++)s+=String.fromCharCode(a);for(var a=0;a<e.length;a++)e[a].start1+=t,e[a].start2+=t;var r=e[0],i=r.diffs;if(i.length==0||i[0][0]!=d)i.unshift(new h.Diff(d,s)),r.start1-=t,r.start2-=t,r.length1+=t,r.length2+=t;else if(t>i[0][1].length){var n=t-i[0][1].length;i[0][1]=s.substring(i[0][1].length)+i[0][1],r.start1-=n,r.start2-=n,r.length1+=n,r.length2+=n}if(r=e[e.length-1],i=r.diffs,i.length==0||i[i.length-1][0]!=d)i.push(new h.Diff(d,s)),r.length1+=t,r.length2+=t;else if(t>i[i.length-1][1].length){var n=t-i[i.length-1][1].length;i[i.length-1][1]+=s.substring(0,n),r.length1+=n,r.length2+=n}return s};h.prototype.patch_splitMax=function(e){for(var t=this.Match_MaxBits,s=0;s<e.length;s++)if(!(e[s].length1<=t)){var a=e[s];e.splice(s--,1);for(var r=a.start1,i=a.start2,n="";a.diffs.length!==0;){var o=new h.patch_obj,l=!0;for(o.start1=r-n.length,o.start2=i-n.length,n!==""&&(o.length1=o.length2=n.length,o.diffs.push(new h.Diff(d,n)));a.diffs.length!==0&&o.length1<t-this.Patch_Margin;){var c=a.diffs[0][0],f=a.diffs[0][1];c===_?(o.length2+=f.length,i+=f.length,o.diffs.push(a.diffs.shift()),l=!1):c===b&&o.diffs.length==1&&o.diffs[0][0]==d&&f.length>2*t?(o.length1+=f.length,r+=f.length,l=!1,o.diffs.push(new h.Diff(c,f)),a.diffs.shift()):(f=f.substring(0,t-o.length1-this.Patch_Margin),o.length1+=f.length,r+=f.length,c===d?(o.length2+=f.length,i+=f.length):l=!1,o.diffs.push(new h.Diff(c,f)),f==a.diffs[0][1]?a.diffs.shift():a.diffs[0][1]=a.diffs[0][1].substring(f.length))}n=this.diff_text2(o.diffs),n=n.substring(n.length-this.Patch_Margin);var u=this.diff_text1(a.diffs).substring(0,this.Patch_Margin);u!==""&&(o.length1+=u.length,o.length2+=u.length,o.diffs.length!==0&&o.diffs[o.diffs.length-1][0]===d?o.diffs[o.diffs.length-1][1]+=u:o.diffs.push(new h.Diff(d,u))),l||e.splice(++s,0,o)}}};h.prototype.patch_toText=function(e){for(var t=[],s=0;s<e.length;s++)t[s]=e[s];return t.join("")};h.prototype.patch_fromText=function(e){var t=[];if(!e)return t;for(var s=e.split(`
...
`],a,r=0;r<this.diffs.length;r++){switch(this.diffs[r][0]){case _:a="+";break;case b:a="-";break;case d:a=" ";break}s[r+1]=a+encodeURI(this.diffs[r][1])+`
`}return s.join("").replace(/%20/g," ")};L.exports=h;L.exports.diff_match_patch=h;L.exports.DIFF_DELETE=b;L.exports.DIFF_INSERT=_;L.exports.DIFF_EQUAL=d});var{ApiService:R}=Shopware.Classes,B=class extends R{constructor(t,s,a="_action/frosh-tools"){super(t,s,a)}getCacheInfo(){let t=`${this.getApiBasePath()}/cache`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}clearCache(t){let s=`${this.getApiBasePath()}/cache/${t}`;return this.httpClient.delete(s,{headers:this.getBasicHeaders()}).then(a=>R.handleResponse(a))}getQueue(){let t=`${this.getApiBasePath()}/queue/list`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}resetQueue(){let t=`${this.getApiBasePath()}/queue`;return this.httpClient.delete(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}runScheduledTask(t){let s=`${this.getApiBasePath()}/scheduled-task/${t}`;return this.httpClient.post(s,{},{headers:this.getBasicHeaders()}).then(a=>R.handleResponse(a))}scheduledTasksRegister(){let t=`${this.getApiBasePath()}/scheduled-tasks/register`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}healthStatus(){if(!this.loginService.isLoggedIn())return;let t=`${this.getApiBasePath()}/health/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}performanceStatus(){let t=`${this.getApiBasePath()}/performance/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}getLogFiles(){let t=`${this.getApiBasePath()}/logs/files`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>R.handleResponse(s))}getLogFile(t,s=0,a=20){let r=`${this.getApiBasePath()}/logs/file`;return this.httpClient.get(r,{params:{file:t,offset:s,limit:a},headers:this.getBasicHeaders()}).then(i=>i)}getShopwareFiles(){let t=`${this.getApiBasePath()}/shopware-files`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>s)}getFileContents(t){let s=`${this.getApiBasePath()}/file-contents`;return this.httpClient.get(s,{params:{file:t},headers:this.getBasicHeaders()}).then(a=>a)}restoreShopwareFile(t){let s=`${this.getApiBasePath()}/shopware-file/restore`;return this.httpClient.get(s,{params:{file:t},headers:this.getBasicHeaders()}).then(a=>a)}stateMachines(t){let s=`${this.getApiBasePath()}/state-machines/load`;return this.httpClient.get(s,{params:{stateMachine:t},headers:this.getBasicHeaders()}).then(a=>R.handleResponse(a))}},N=B;var{ApiService:E}=Shopware.Classes,P=class extends E{constructor(t,s,a="_action/frosh-tools/elasticsearch"){super(t,s,a)}status(){let t=`${this.getApiBasePath()}/status`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}indices(){let t=`${this.getApiBasePath()}/indices`;return this.httpClient.get(t,{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}deleteIndex(t){let s=`${this.getApiBasePath()}/index/`+t;return this.httpClient.delete(s,{headers:this.getBasicHeaders()}).then(a=>E.handleResponse(a))}console(t,s,a){let r=`${this.getApiBasePath()}/console`+s;return this.httpClient.request({url:r,method:t,headers:{...this.getBasicHeaders(),"content-type":"application/json"},data:a}).then(i=>E.handleResponse(i))}flushAll(){let t=`${this.getApiBasePath()}/flush_all`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}reindex(){let t=`${this.getApiBasePath()}/reindex`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}switchAlias(){let t=`${this.getApiBasePath()}/switch_alias`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}cleanup(){let t=`${this.getApiBasePath()}/cleanup`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}reset(){let t=`${this.getApiBasePath()}/reset`;return this.httpClient.post(t,{},{headers:this.getBasicHeaders()}).then(s=>E.handleResponse(s))}},H=P;var{Application:I}=Shopware;I.addServiceProvider("froshToolsService",e=>{let t=I.getContainer("init");return new N(t.httpClient,e.loginService)});I.addServiceProvider("froshElasticSearch",e=>{let t=I.getContainer("init");return new H(t.httpClient,e.loginService)});var O=`{% block sw_data_grid_inline_edit_type_unknown %}
    <sw-datepicker
...
`;var{Component:Ee,Mixin:$e}=Shopware;Ee.register("frosh-tools-tab-state-machines",{template:K,inject:["froshToolsService"],mixins:[$e.getByName("notification")],data(){return{image:null,isLoading:!0}},created(){this.createdComponent()},methods:{createdComponent(){this.isLoading=!1},async onStateMachineChange(e){let t=await this.froshToolsService.stateMachines(e),s=document.getElementById("state_machine");"svg"in t?(this.image=t.svg,s.src=this.image,s.style.opacity="1",s.style.width="100%",s.style.height="auto"):s.style.opacity="0"}}});var Z=`<sw-card-view>
